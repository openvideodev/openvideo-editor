...
const WorkflowsPage = () => {
    const workflows = [
        {
            title: "UGC Video Ads",
            description: "Create authentic user-style ads with AI avatars interacting with your product. Perfect for TikTok and Instagram.",
            icon: <Video size={24} />,
        },
        {
            title: "Product Video Ads",
            description: "Generate high-converting promo videos from your product assets and descriptions. Tailored for e-commerce growth.",
            icon: <Sparkles size={24} />,
        },
        {
            title: "AI Narrative Video",
            description: "Transform scripts into creative storytelling, motivational, or educational videos with dynamic visuals.",
            icon: <Brain size={24} />,
        },
        {
            title: "AI Editor",
            description: "Professional video editing app powered by AI tools. Crop, trim, and enhance your footage with just a few clicks.",
            icon: <Scissors size={24} />,
        },
        {
            title: "AI Copilot",
            description: "Chat with your footage to generate viral clips, summaries, and social media content automatically.",
            icon: <Bot size={24} />,
        },
        {
            title: "Smart Captions",
            description: "Add trendy captions, b-rolls, sound effects, and background music to make your videos stand out.",
            icon: <RefreshCw size={24} />,
        },
        {
            title: "Link to Video",
            description: "Turn any URL—product pages, articles, or blog posts—into a polished and professional video presentation.",
            icon: <Zap size={24} />,
        },
    ];
            ...
            <section className="flex flex-col items-center justify-center gap-16 py-28 p-8 text-center px-4 w-full border-b max-w-7xl mx-auto">
                <div className="flex items-center justify-center gap-6 flex-col">
                    ...
                    <p className="max-w-2xl mx-auto max-sm:text-sm text-muted-foreground text-lg">
                        Professional AI services tailored for scale. Select a workflow to see how we can transform your content production.
                    </p>
                </div>{" "}
